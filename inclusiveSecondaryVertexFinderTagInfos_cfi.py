...
inclusiveSecondaryVertexFinderTagInfosFilteredTemp = secondaryVertexTagInfos.clone()
inclusiveSecondaryVertexFinderTagInfosFilteredTemp.extSVCollection     = cms.InputTag('bToCharmDecayVertexMerged')
inclusiveSecondaryVertexFinderTagInfosFilteredTemp.useExternalSV = cms.bool(True)
inclusiveSecondaryVertexFinderTagInfosFilteredTemp.vertexCuts.fracPV = 0.79 ## 4 out of 5 is discarded
inclusiveSecondaryVertexFinderTagInfosFilteredTemp.vertexCuts.distSig2dMin = 2.0
inclusiveSecondaryVertexFinderTagInfosFilteredTemp.extSVDeltaRToJet    = cms.double(0.8)
inclusiveSecondaryVertexFinderTagInfosFilteredTemp.vertexCuts.maxDeltaRToJetAxis = cms.double(0.8)
